...
app.use((req, res, next) => {
    ...
    const data = stmt.run(logdata.remoteaddr), (logdata.remoteuser), (logdata.time), (logdata.method), (logdata.url), (logdata.protocol), (logdata.httpversion), (logdata.status), String(logdata.referrer),(logdata.useragent)
    next();
});
